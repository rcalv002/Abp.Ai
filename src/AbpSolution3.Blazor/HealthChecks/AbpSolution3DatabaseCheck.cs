...
public class AbpSolution3DatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public AbpSolution3DatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
